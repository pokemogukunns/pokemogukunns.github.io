...
app.mount("/category2", StaticFiles(directory="./category/2-player.html", html=True), name="static")
app.mount("/category3", StaticFiles(directory="./category/3d.html", html=True), name="static")
app.mount("/categoryac", StaticFiles(directory="./category/action.html", html=True), name="static")
app.mount("/categoryad", StaticFiles(directory="./category/adventure.html", html=True), name="static")
app.mount("/categoryc", StaticFiles(directory="./category/car.html", html=True), name="static")
app.mount("/categoryf", StaticFiles(directory="./category/fighting.html", html=True), name="static")
app.mount("/categoryi", StaticFiles(directory="./category/idle.html", html=True), name="static")
app.mount("/categorymo", StaticFiles(directory="./category/moto.html", html=True), name="static")
app.mount("/categorymu", StaticFiles(directory="./category/multiplayer.html", html=True), name="static")
app.mount("/categoryn", StaticFiles(directory="./category/new.html", html=True), name="static")
app.mount("/categorypo", StaticFiles(directory="./category/popular.html", html=True), name="static")
app.mount("/categorypu", StaticFiles(directory="./category/puzzle.html", html=True), name="static")
app.mount("/categoryra", StaticFiles(directory="./category/racing.html", html=True), name="static")
app.mount("/categoryru", StaticFiles(directory="./category/running.html", html=True), name="static")
app.mount("/categorysh", StaticFiles(directory="./category/shooting.html", html=True), name="static")
app.mount("/categorysk", StaticFiles(directory="./category/skill.html", html=True), name="static")
app.mount("/categorysp", StaticFiles(directory="./category/sports.html", html=True), name="static")
app.mount("/categoryst", StaticFiles(directory="./category/stickman.html", html=True), name="static")
