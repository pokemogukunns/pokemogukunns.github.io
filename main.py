...
app.mount("/category/2-player.html", StaticFiles(directory="./category/2-player.html", html=True), name="static")
app.mount("/category/3d.html", StaticFiles(directory="./category/3d.html", html=True), name="static")
app.mount("/category/action.html", StaticFiles(directory="./category/action.html", html=True), name="static")
app.mount("/category/adventure.html", StaticFiles(directory="./category/adventure.html", html=True), name="static")
app.mount("/category/car.html", StaticFiles(directory="./category/car.html", html=True), name="static")
app.mount("/category/fighting.html", StaticFiles(directory="./category/fighting.html", html=True), name="static")
app.mount("/category/idle.html", StaticFiles(directory="./category/idle.html", html=True), name="static")
app.mount("/category/moto.html", StaticFiles(directory="./category/moto.html", html=True), name="static")
app.mount("/category/multiplayer", StaticFiles(directory="./category/multiplayer.html", html=True), name="static")
app.mount("/category/new.html", StaticFiles(directory="./category/new.html", html=True), name="static")
app.mount("/category/popular.html", StaticFiles(directory="./category/popular.html", html=True), name="static")
app.mount("/category/puzzle.html", StaticFiles(directory="./category/puzzle.html", html=True), name="static")
app.mount("/category/racing.html", StaticFiles(directory="./category/racing.html", html=True), name="static")
app.mount("/category/running.html", StaticFiles(directory="./category/running.html", html=True), name="static")
app.mount("/category/shooting.html", StaticFiles(directory="./category/shooting.html", html=True), name="static")
app.mount("/category/skill.html", StaticFiles(directory="./category/skill.html", html=True), name="static")
app.mount("/category/sports.html", StaticFiles(directory="./category/sports.html", html=True), name="static")
app.mount("/category/stickman.html", StaticFiles(directory="./category/stickman.html", html=True), name="static")
